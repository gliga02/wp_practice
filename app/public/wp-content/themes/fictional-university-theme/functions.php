<?php
    ...
    function university_files() {
        wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyC1vebUmcBdClXdG6IvWRoejGR1_6AIv7I', NULL, '1.0', true);
    ...
    function universityMapKey($api) {
        $api['key'] = 'AIzaSyC1vebUmcBdClXdG6IvWRoejGR1_6AIv7I';
        return $api;
    }
